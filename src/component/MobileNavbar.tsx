...
export default function MobileNavbar({ isNavOpen, toggleNav }: MobileNavbarProps) {
  ...
  return (
    <div
      className={`hamLists z-[999] fixed top-16 w-full p-5 flex align-middle justify-between shadow-2xl bg-base-100 md:hidden transition-all duration-300 ease-in-out
      ${isNavOpen ? "max-h-fit opacity-100 visible" : "max-h-0 opacity-0 invisible overflow-hidden"} 
      `}
    >
      <ul className="flex flex-col justify-evenly items-left w-full">
        <li>
          <NavLink to="/" className={({ isActive }: NavLinkClassNameProps) => 
        ...
        <li>
          <NavLink to="/company" className={({ isActive }: NavLinkClassNameProps) => 
              isActive ? "navLink active" : "navLink"
            } onClick={toggleNav}>
            公司
          </NavLink>
        ...
        <li>
          <NavLink to="/life" className={({ isActive }: NavLinkClassNameProps) => 
              isActive ? "navLink active" : "navLink"
            } onClick={toggleNav}>
            生平
          </NavLink>
        ...
        <li>
          <NavLink to="/news" className={({ isActive }: NavLinkClassNameProps) => 
              isActive ? "navLink active" : "navLink"
            } onClick={toggleNav}>
            新聞
          </NavLink>
        ...
        <li>
          <NavLink to="/info" className={({ isActive }: NavLinkClassNameProps) => 
              isActive ? "navLink active" : "navLink"
            } onClick={toggleNav}>
            更多消息
          </NavLink>
        ...
        <li>
          ...
          {loading ? (
            ...
            <NavLink to="/login" className={({ isActive }: NavLinkClassNameProps) => 
              isActive ? "navLink active" : "navLink"
            } onClick={toggleNav}>
              登入
            </NavLink>
